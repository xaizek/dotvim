...
function! s:deletesurround() " {{{1
  let a = <SID>inputtarget()
  let line = line(".")
  let col = col(".")
  call s:dosurround(a)
  call cursor(line, col - len(a))
endfunction " }}}1
...
nnoremap <silent> <Plug>Dsurround  :<C-U>call <SID>deletesurround()<CR>
